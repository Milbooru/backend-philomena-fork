...
seed_dev_fixtures? =
  System.get_env("PHILOMENA_SEED_DEV_FIXTURES", "false")
  |> String.downcase()
  |> then(&(&1 in ["1", "true", "yes"]))

if seed_dev_fixtures? do
  ...
  IO.puts("---- Skipping development fixtures (set PHILOMENA_SEED_DEV_FIXTURES=true to enable)")
end
